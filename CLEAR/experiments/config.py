...
METRICS = {
    "MIG-RMIG": {
        "function": mig,
        "kwargs": {"continuous_factors": True, "nb_bins": 10},
    },
    "DCIMIG": {
        "function": dcimig,
        "kwargs": {"continuous_factors": True, "nb_bins": 10},
    ...
    "Explicitness Score": {
        ...
        "kwargs": {"continuous_factors": True, "nb_bins": 10, "scale": True, "impl": 1},
    },
    "SAP": {
        "function": sap,
        "kwargs": {"continuous_factors": True, "nb_bins": 10, "regression": True},
    },
    "IRS": {
        "function": irs,
        "kwargs": {"continuous_factors": True, "nb_bins": 10, "diff_quantile": 1.0},
    },
    "Z-min Variance": {
        "function": z_min_var,
        "kwargs": {
